...
-- ----------------------------
INSERT INTO `t_oauth_client_details` VALUES ('gitegg-admin', NULL, '123456', 'all', 'password,captcha,sms_captcha,social,refresh_token,authorization_code', NULL, NULL, 3600, 7200, NULL, 'true', NULL, NULL, NULL, NULL, 0);
INSERT INTO `t_oauth_client_details` VALUES ('gitegg-weapp', NULL, '123456', 'all', 'password,captcha,sms_captcha,social,refresh_token,authorization_code', NULL, NULL, 3600, 7200, NULL, 'true', NULL, NULL, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `t_sys_code_generator_datasource` VALUES (75, 0, '测试数据库001', 'jdbc:mysql://127.0.0.1/gitegg_boot?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=Asia/Shanghai', 'root', 'root', '', 'mysql', '', '2021-11-11 19:06:11', 1, '2021-11-11 19:15:29', 1, 0);
-- ----------------------------
...
INSERT INTO `t_sys_data_permission_user` VALUES (30, 0, 7, 12, 1, '2021-12-22 17:06:07', 1, NULL, NULL, 0);
...
INSERT INTO `t_sys_data_permission_user` VALUES (59, 0, 36, 1, 1, '2022-06-05 20:23:36', NULL, NULL, NULL, 0);
INSERT INTO `t_sys_data_permission_user` VALUES (60, 0, 37, 1, 1, '2022-06-17 16:47:06', NULL, NULL, NULL, 0);
INSERT INTO `t_sys_data_permission_user` VALUES (61, 0, 38, 1, 1, '2022-06-20 14:28:54', NULL, NULL, NULL, 0);
...
INSERT INTO `t_sys_dfs` VALUES (2, 0, 3, 'QINiuKODO', 'http://qss6id4y7.hn-bkt.clouddn.com', 'http://upload.qiniup.com', 'gitegg', 'gitegg', 'zone0', '111111111', '1111111111', 0, 1, 0, '七牛云存储', '2021-05-06 14:09:50', 1, '2021-05-07 09:50:49', 1, 0);
...
INSERT INTO `t_sys_organization` VALUES (17, 0, 11, '0,11', '1', '555', '555', '555', 555, 1, '110000', '110100', '110101', '98', '888', '2021-07-06 17:46:41', 1, '2022-05-29 23:17:40', 17, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 259 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_resource` VALUES (11, 0, 2, '0,1,2', '日志管理', 'system:log:mgr', '2', 'rizhiguanli', 'system/log', 'nested', 100, 1, 1, NULL, 1, '', '2018-10-27 17:37:17', 1, '2022-05-16 14:13:24', 1, 0);
...
CREATE TABLE `t_sys_role_resource`  (
  ...
  `del_flag` tinyint(2) NOT NULL DEFAULT 0 COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 345 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色和权限关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_role_resource` VALUES (342, 0, 2, 251, '2022-06-16 18:25:29', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (343, 0, 2, 253, '2022-06-16 18:25:29', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (344, 0, 2, 254, '2022-06-17 14:56:16', 1, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `t_sys_sms_channel` VALUES (1, 0, 'aliyun', '阿里云短信', '22222222', '11111', 'cn-hangzhou', 1, 10000000, '2122-12-31 23:59:59', '阿里云短信', '2021-01-26 15:19:11', 1, '2022-05-25 13:51:32', 1, 0);
INSERT INTO `t_sys_sms_channel` VALUES (5, 0, 'tencent', '腾讯云短信', '111', '111', '111', 0, 1000000, '2122-12-31 23:59:59', '腾讯云短信', '2022-05-25 13:50:36', 1, '2022-05-25 13:51:47', 1, 0);
INSERT INTO `t_sys_sms_channel` VALUES (6, 0, 'qiniu', '七牛云短信', '222', '222', '222', 0, 1000000, '2122-12-31 23:59:59', '七牛云短信', '2022-05-25 13:51:15', 1, '2022-05-25 13:51:49', 1, 0);
...
-- ----------------------------
INSERT INTO `t_sys_sms_template` VALUES (1, 0, 1, 'sms_login_code', '登录验证码', 'SMS_152420163', '11111111', 1, 1, 'SMS:CODE:LOGIN', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:39:21', 1, '2022-05-25 13:40:11', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (2, 0, 1, 'sms_register_code', '注册验证码', 'SMS_152420161', '11111111', 1, 1, 'SMS:CODE:REGISTER', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:41:37', 1, '2022-05-25 13:41:46', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (3, 0, 1, 'sms_change_pwd_code', '修改密码验证码', 'SMS_152420160', '1111111', 1, 1, 'SMS:CODE:CHANGE:PWD', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试修改登录密码，请妥善保管账户信息。', '2022-05-25 13:43:35', 1, '2022-05-25 13:46:19', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (4, 0, 1, 'sms_change_info_code', '信息变更验证码', 'SMS_152420159', '111111111', 1, 1, 'SMS:CODE:CHANGE:INFO', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试变更重要信息，请妥善保管账户信息。', '2022-05-25 13:45:52', 1, '2022-05-25 14:44:47', 1, 0);
...
INSERT INTO `t_sys_user` VALUES (2, 0, 'test001', 'test001', 'test001', '0', 'test001@qq.com', '15850685632', '$2a$10$wm3EX5HnBslChBBYTgfP8e8B6jslFUreh/8bblJ1TRsSA2mOnDpoi', 1, NULL, NULL, '320000', '320300', '320303', '2342342343', '2342343', '2020-11-27 16:43:06', 1, '2021-12-22 17:06:16', 1, 0);
INSERT INTO `t_sys_user` VALUES (3, 0, 'test002', 'test002', 'test002', '1', 'test002@qq.com', '15851111557', '$2a$10$MBsO4f0tIMIIdjcLUSUNd.fu6yZakXRcK9Ck.XypALznIhMYpFUKG', 1, NULL, NULL, '320000', '320100', '320104', '234423423', '234234', '2020-11-27 02:55:30', 1, '2022-05-29 23:17:10', 17, 0);
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户和角色关联表' ROW_FORMAT = DYNAMIC;
