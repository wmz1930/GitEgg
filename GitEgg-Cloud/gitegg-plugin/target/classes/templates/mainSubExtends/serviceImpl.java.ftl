...
import ${mainPackagePath}.dto.Create${mainEntityName}DTO;
import ${mainPackagePath}.dto.Update${mainEntityName}DTO;
...
public class ${table.serviceImplName} extends ${superServiceImplClass}<${table.mapperName}, ${entity}> implements ${table.serviceName} {
    ...
    */
    ...
    public boolean create${entity}(Create${entity}DTO ${table.entityPath}) {
        ...
        Create${mainEntityName}DTO ${mainEntityName?uncap_first}DTO = BeanCopierUtils.copyByClass(${table.entityPath}, Create${mainEntityName}DTO.class);
        ${mainEntityName} ${mainEntityName?uncap_first} = ${mainEntityName?uncap_first}Service.create${mainEntityName}(${mainEntityName?uncap_first}DTO);
    ...
    */
    ...
    public boolean update${entity}(Update${entity}DTO ${table.entityPath}) {
        Update${mainEntityName}DTO ${mainEntityName?uncap_first} = BeanCopierUtils.copyByClass(${table.entityPath}, Update${mainEntityName}DTO.class);
        boolean result = ${mainEntityName?uncap_first}Service.update${mainEntityName}(${mainEntityName?uncap_first});
        if (result)
        {
            ${entity} ${table.entityPath}Entity = BeanCopierUtils.copyByClass(${table.entityPath}, ${entity}.class);
            QueryWrapper<${entity}> wrapper = new QueryWrapper<>();
            wrapper.eq("${columnName}", ${table.entityPath}.getId());
            result = this.update(${table.entityPath}Entity, wrapper);
        }
        return result;
    }
