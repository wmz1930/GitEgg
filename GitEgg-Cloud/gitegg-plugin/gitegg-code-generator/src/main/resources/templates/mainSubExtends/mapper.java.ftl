...
public interface ${table.mapperName} extends ${superMapperClass}<${entity}> {
    ...
    * @return
    */
    Page<${entity}DTO> query${mainEntityName}${entity}List(Page<${entity}DTO> page, @Param("${table.entityPath}") Query${entity}DTO ${table.entityPath}DTO);
    ...
    * @return
    */
    List<${entity}DTO> query${mainEntityName}${entity}List(@Param("${table.entityPath}") Query${entity}DTO ${table.entityPath}DTO);
    <#if config?? && config.queryReuse == false>
    ...
    * @return
    */
    ${entity}DTO query${mainEntityName}${entity}(@Param("${table.entityPath}") Query${entity}DTO ${table.entityPath}DTO);
