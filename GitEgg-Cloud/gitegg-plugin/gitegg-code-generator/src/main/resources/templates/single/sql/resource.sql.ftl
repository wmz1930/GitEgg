...
(
   ...
   0,
   '${table.comment!}数据导出',
   '${config.serviceName?replace("-",":")}:<#if config.controllerPath?? && config.controllerPath != "">${config.controllerPath?replace("/","","f")?replace("/",":")}<#else>/${table.entityPath}</#if>:export',
   '4',
   'xitongrizhi',
   'export',
...
(
   ...
   0,
   '${table.comment!}数据导入',
   '${config.serviceName?replace("-",":")}:<#if config.controllerPath?? && config.controllerPath != "">${config.controllerPath?replace("/","","f")?replace("/",":")}<#else>/${table.entityPath}</#if>:import',
   '4',
   'xitongrizhi',
   'import',
