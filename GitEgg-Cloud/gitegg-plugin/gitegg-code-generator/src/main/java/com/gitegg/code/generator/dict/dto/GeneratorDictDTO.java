 ...
 */
@Data
@ApiModel(value = "GeneratorDictDTO对象", description = "代码生成数据字典")
public class GeneratorDictDTO implements Serializable {
    ...
    private List<GeneratorDictDTO> children = new ArrayList<>();
