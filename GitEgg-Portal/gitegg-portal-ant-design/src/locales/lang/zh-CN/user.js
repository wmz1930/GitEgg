export default {
  ...
  'user.login.account.placeholder': '请输入账号/手机号/邮箱地址',
  'user.login.nickname.placeholder': '请输入昵称',
  'user.login.password.placeholder': '请输入密码',
  'user.login.password.twice.placeholder': '请再次输入密码',
