<template>
  <div class="app-container content">
          ...
          <el-row>
            ...
            <el-col :span="6" class="line">
              <el-form-item :label="$t('userTable.realName')" prop="realName">
                <el-input v-model="listQuery.realName" :placeholder="$t('userTable.realName')" style="width: 180px;" class="filter-item" maxlength="32" @keyup.enter.native="handleFilter" />
              </el-form-item>
            </el-col>
            <el-col :span="6" class="line">
    ...
    >
      ...
      <el-table-column :label="$t('userTable.account')" width="" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.account }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('userTable.realName')" width="" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('userTable.gender')" width="" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.actions')" align="center" width="310" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.status!='1'" size="mini" type="success" @click="handleModifyStatus(scope.row,'1')">{{ $t('userTable.enable') }}
          </el-button>
          <el-button v-if="scope.row.status!='0' && scope.row.status!='2'" size="mini" @click="handleModifyStatus(scope.row,'0')">{{ $t('userTable.disable') }}
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form ref="userForm" :model="userForm" :rules="rules" label-width="100px" class="userForm" style="width: 400px; margin-left:50px;">
        <el-form-item :label="$t('userTable.organization')" prop="account">
          <el-cascader
        ...
        <el-form-item :label="$t('userTable.account')" prop="account">
        ...
        <el-form-item :label="$t('userTable.gender')" prop="gender">
        ...
        <el-form-item :label="$t('userTable.comments')">
...
<script>
import { fetchList, createUser, deleteUser, updateUser, updateStatus, fetchRoleList, updateUserDataPermission, checkUserExist } from '@/api/system/user'
