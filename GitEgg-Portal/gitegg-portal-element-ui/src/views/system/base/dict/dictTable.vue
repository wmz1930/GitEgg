<template>
  <div class="app-container">
    ...
    <el-table :data="list" row-key="id" border>
      ...
      <el-table-column :label="$t('dictTable.comments')">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dictForm" :model="dictForm" :rules="rules" label-width="100px" class="dictForm" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('dictTable.comments')">
          <el-input v-model.trim="dictForm.comments" :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="请输入备注信息" />
        </el-form-item>
      </el-form>
...
import { fetchList, createDict, deleteDict, updateDict } from '@/api/system/base/dict'
