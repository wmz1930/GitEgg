<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('userTable.userGender')" width="" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.userGender | sexNameFilter }}</span>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.userForm.userGender = parseInt(this.userForm.userGender)
