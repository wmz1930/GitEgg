...
<script lang="ts">
  ...
  import { dictFormSchema } from './dict.business.data';
  import { BasicModal, useModalInner } from '/@/components/Modal';
  import { createDictBusiness, updateDictBusiness } from '/@/api/system/base/dictBusiness';
    ...
    setup(_, { emit }) {
      ...
      async function handleSubmit() {
        try {
          ...
          if (unref(isUpdate)) {
            await updateDictBusiness(values);
          } else {
            await createDictBusiness(values);
          }
          closeModal();
