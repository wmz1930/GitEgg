...
<script lang="ts">
  ...
  import {
    getDictBusinessList,
    deleteDictBusiness,
    batchDeleteDictBusiness,
  } from '/@/api/system/base/dictBusiness';
  import { useModal } from '/@/components/Modal';
  import DictModal from './DictBusinessModal.vue';

  import { columns, getSearchFormConfig } from './dict.business.data';
  ...
  export default defineComponent({
    ...
    setup(_, { attrs, emit }) {
      ...
      function handleBatchDelete() {
        batchDeleteDictBusiness(checkedKeys.value)
          .then(() => {
            createMessage.success(`数据字典删除成功`);
            checkedKeys.value = [];
            reload();
