<template>
  <div>
    ...
    >
      <template #tableTitle>
        <a-button type="primary" @click="handleCreate" class="mr-2">
          <icon icon="ant-design:plus-outlined" /> 新增短信模板
        </a-button>
        <Dropdown
    ...
    <SmsTemplateDrawer @register="registerDrawer" @success="handleSuccess" />
  </div>
</template>
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function handleBatchDelete() {
        batchDeleteSmsTemplate(checkedKeys.value)
          .then(() => {
            createMessage.success(`短信模板删除成功`);
            checkedKeys.value = [];
            reload();
