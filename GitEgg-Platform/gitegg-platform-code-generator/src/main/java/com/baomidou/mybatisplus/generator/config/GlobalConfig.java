...
public class GlobalConfig {
    ...
    /**
     * 生成前端文件的输出目录【 windows:D://  linux or mac:/tmp 】
     */
    private String outputFrontDir = System.getProperty("os.name").toLowerCase().contains("windows") ? "D://" : "/tmp";
    ...
    public String getOutputFrontDir() {
        return outputFrontDir;
    }
    ...
    public static class Builder implements IConfigBuilder<GlobalConfig> {
        ...
        public Builder outputFrontDir(@NotNull String outputFrontDir) {
            this.globalConfig.outputFrontDir = outputFrontDir;
            return this;
        }
