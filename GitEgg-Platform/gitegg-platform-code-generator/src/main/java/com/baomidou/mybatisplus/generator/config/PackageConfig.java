...
public class PackageConfig {
     ...
     * vue包名
     */
    private String vue = File.separator + "src" + File.separator + "views" + File.separator;

    /**
     * js包名
     */
    private String js = File.separator + "src" + File.separator + "api" + File.separator;
     ...
     * 自定义生成配置信息
     */
    Map<String, Object> paramsConfigMap = new HashMap<>();
     ...
     */
    @NotNull
    public String joinPackageFront(String subPackage) {
        String parent = getParent();
        return StringUtils.isBlank(parent) ? subPackage : (parent + StringPool.DOT + subPackage);
    }
    ...
    public Map<String, Object> getParamsConfigMap() {
        return paramsConfigMap;
    }
    ...
    public static class Builder implements IConfigBuilder<PackageConfig> {
         ...
         * 路径配置信息
         *
         * @param paramsConfigMap 路径配置信息
         * @return this
         */
        public Builder paramsConfigMap(Map<String, Object> paramsConfigMap) {
            this.packageConfig.paramsConfigMap = paramsConfigMap;
            return this;
        }
